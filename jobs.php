                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="" class="citySearch" data-target="Peshawar"><i class="fa fa-circle-o text-yellow"></i> Peshawar</a></li>
                      <li><a href="" class="citySearch" data-target="Rawalpindi"><i class="fa fa-circle-o text-yellow"></i> Rawalpindi</a></li>
                      <li><a href="" class="citySearch" data-target="Quetta"><i class="fa fa-circle-o text-yellow"></i> Quetta</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
